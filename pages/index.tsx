...
const Home: NextPage = () => {
  return (
    <Container maxW={"1200px"}>
      <Flex direction={"column"} h={"650px"} justifyContent={"center"} alignItems={"center"}>
        
        <Heading my={"40px"}>IneverToken</Heading>
